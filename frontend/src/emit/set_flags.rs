...
const WORD_TYPE: ir::Type = ir::Type::U64;
...
impl SetFlagsType {
    ...
    pub fn define_new(module: &mut ModuleBuilder, bit_count: usize) -> Self {
        let word_count = usize::div_ceil(bit_count, WORD_BITS);
    ...
    fn define_include(
        ...
        let func = ir::Function::Local(ir::FunctionDef {
            ...
            debug_name: String::from("Include (256-bit flags)"),
            body: builder.finish(),
        });
    ...
    fn define_exclude(struct_id: ir::TypeDefID, word_count: usize, module: &mut ModuleBuilder) -> ir::FunctionID {
        ...
        let func = ir::Function::Local(ir::FunctionDef {
            ...
            debug_name: String::from("Exclude (256-bit flags)"),
            body: builder.finish(),
        });
    ...
    fn define_contains(struct_id: ir::TypeDefID, word_count: usize, module: &mut ModuleBuilder) -> ir::FunctionID {
        ...
        let func = ir::Function::Local(ir::FunctionDef {
            ...
            debug_name: String::from("Contains (256-bit flags)"),
            body: builder.finish(),
        });
    ...
    fn find_word_bit(builder: &mut Builder, first_arg: usize, word_count: usize, struct_ty: ir::Type) -> (ir::Ref, ir::Value) {
        ...
        for word in (0..word_count).rev() {
            ...
            builder.lt(skip_flag.clone(), bit_arg.clone(), word_start.clone());
