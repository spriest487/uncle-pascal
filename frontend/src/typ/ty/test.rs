...
fn specialized_class_has_correct_non_generic_method_types() {
    ...
    assert_eq!("test.A[T]", methods[0].decl.params[0].ty.to_string());
    assert_eq!("test.A[T]", methods[0].decl.name.owning_ty.as_ref().unwrap().to_string());
    assert_eq!(BYTE, methods[0].decl.params[1].ty);
    assert_eq!(BYTE, methods[0].decl.return_ty);
    ...
    assert_eq!("test.A[System.Int32]", methods[0].decl.name.owning_ty.as_ref().unwrap().to_string());
    assert_eq!("test.A[System.Int32]", methods[0].decl.params[0].ty.to_string());
    assert_eq!(BYTE, methods[0].decl.params[1].ty);
    assert_eq!(BYTE, methods[0].decl.return_ty);
}
...
fn specialized_class_has_correct_method_types_using_class_ty_params() {
    ...
    let methods: Vec<_> = generic_def.methods().collect();
    assert_eq!("test.A[T]", methods[0].decl.params[0].ty.to_string());
    assert_eq!("T", methods[0].decl.params[1].ty.to_string());
    assert_eq!("T", methods[0].decl.return_ty.to_string());
    ...
    let methods: Vec<_> = specialized_def.methods().collect();
    assert_eq!("test.A[System.Int32]", methods[0].decl.params[0].ty.to_string());
    assert_eq!(INT32, methods[0].decl.params[1].ty);
    assert_eq!(INT32, methods[0].decl.return_ty);
}
...
fn specialized_class_has_correct_method_types_with_method_ty_params() {
    ...
    let methods: Vec<_> = specialized_def.methods().collect();
    assert_eq!(self_ty, methods[0].decl.params[0].ty);
    assert_eq!(INT32, methods[0].decl.params[1].ty);
    assert_eq!(BYTE, methods[0].decl.params[2].ty);
    assert_eq!(generic_u, methods[0].decl.return_ty);
}
