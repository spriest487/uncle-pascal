...
pub fn translate_case_expr(case: &pas_ty::ast::CaseExpr, builder: &mut Builder) -> Ref {
...
pub fn translate_match_expr(match_expr: &pas_ty::ast::MatchExpr, builder: &mut Builder) -> Ref {
